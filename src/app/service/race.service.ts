...
export class RaceService {
  ...
  constructor() {
    this.raceList = [
      new Race('2024-10-26', 'Javelina Jundred 100mi', '', 'https://aravaiparunning.com/network/javelinajundred/'),
      new Race('2024-09-21', 'The Georgia Jewel 50mi', '', 'https://ultrasignup.com/register.aspx?did=111526'),
      new Race('2024-05-31', 'NYC Trail Fest 50K', '', 'https://trialsofmilesracing.com/tom/nyctrailfest'),
      new Race('2024-05-05', 'Colorado Marathon', '3:11:38', 'https://raceday.enmotive.com/#/events/2024-colorado-marathon/results?category=marathon&bracket_id=5514ff32-008a-4e89-8b95-26b6a098965c&page=1'),
      new Race('2023-11-18', 'Pumpkin Pie 5K', '20:30', 'https://www.coloradorunnerevents.com/pumpkin/results-photos-and-media/2023-results-5k/'),
      new Race('2023-10-08', 'Paine to Pain Trail Half', '1:35:47', 'https://runsignup.com/Race/Results/82001#resultSetId-412898;perpage:100'),
      new Race('2023-08-19', 'Leadville Trail 100mi', 'DNF', 'https://www.athlinks.com/event/33913/results/Event/1021693/Results'),
      new Race('2023-07-29', 'Mile High Mile', '5:24', 'https://femmertiming.com/2023/2023_Mile_High_Mile/results_67.html#round_1_heat_2'),
      new Race('2023-07-29', 'Pikes Peak Ultra 30K', '2:50:01', 'https://ultrasignup.com/results_event.aspx?did=97162'),
      new Race('2023-05-23', 'Dash and Dine 5K', '20:33', 'https://racingunderground.racetecresults.com/results.aspx?CId=16436&RId=7012&mc_cid=7d992cf1c7&mc_eid=54a2afa6e7'),
      new Race('2023-02-18', 'Black Canyon 100K', '13:44:01', 'https://ultrasignup.com/results_event.aspx?did=93392'),
      new Race('2023-01-14', 'We Are Houston 5K', '18:21', 'https://rtrt.me/render/badges?e=HOU-2023&pid=RA5LY9WU&resp=1&bgcolor=fff&filename=hou-2023ra5ly9wu'),
      new Race('2022-12-05', 'California International Marathon', '3:12:42', 'https://www.athlinks.com/event/3241/results/Event/1036173/Course/2307831/Bib/3185'),
      new Race('2022-11-05', 'Dash to the Finish Line 5K', '18:58', 'https://results.nyrr.org/event/22DASH/finishers'),
      new Race('2022-07-04', 'Niwot Downhill Mile', '5:19', 'https://racingunderground.racetecresults.com/results.aspx?CId=16436&RId=5052'),
      new Race('2022-07-04', 'Superior Downhill Mile', '4:54', 'https://racingunderground.racetecresults.com/results.aspx?CId=16436&RId=562'),
      new Race('2022-06-05', 'Colorado 13er Half Marathon', '1:33:21', 'https://runsignup.com/Race/Results/10366?rsus=100-200-607adf4f-487f-4521-a28e-b2afb0a7f647#resultSetId-320589;perpage:10'),
      new Race('2022-05-01', 'Colorado Marathon', '3:04:52', 'http://results2.xacte.com/#/e/2435/searchable'),
      new Race('2022-01-08', 'Bandera 100K', '13:09:52', 'http://edsresults.com/bandera22/index.php?search_type=runner_lookup&bib=162'),
      new Race('2021-08-21', 'Leadville Trail 100mi', 'DNF', 'https://www.athlinks.com/event/33913/results/Event/977377/Results'),
      new Race('2021-06-05', 'North Fork 50mi', '10:43:31', 'https://ultrasignup.com/results_event.aspx?did=78902'),
      new Race('2021-05-22', 'NYCRUNS Summer Loving 5K', '17:37', 'https://nycruns.com/race-results?race=nycruns-summer-loving-5k-10k-3'),
      new Race('2021-02-13', 'Black Canyon 100K', '12:35:18', 'https://ultrasignup.com/results_event.aspx?did=77199'),
      new Race('2021-01-09', 'Bandera 100K', '11:56:56', 'http://edsresults.com/bandera21/index.php?search_type=race_results&event=100K&gender=Overall&results_per_page=400'),
      new Race('2020-10-10', 'Antelope Island Half Marathon', '1:28:23', 'https://www.webscorer.com/racedetails?raceid=225024&did=254436'),
      new Race('2020-06-19', 'Brooklyn Mile', '4:59.6', 'https://vdoto2.com/virtual-racing/results/1006'),
      ...
      new Race('2016-03-06', 'Caumsett State Park 50K', '4:03:23', 'https://ultrarunning.com/calendar/event/caumsett/race/15595/results'),
      ...
      new Race('2014-12-06', 'NYC Trail Festival 50K', '4:39:15', 'https://my.raceresult.com/33382/#5_AC9115'),
