...
export class RaceService {
  ...
  constructor() {
    this.raceList = [
      ...
      new Race('2019-12-08', 'California International Marathon', '', 'https://runsra.org/california-international-marathon/'),
      ...
      new Race('2019-10-05', 'Castle Rock Trail Festival 10K', '45:05', '/results/2019_USATF_CO_Championship_Trail10K_Results.tif'),
      ...
      new Race('2018-08-18', 'Leadville Trail 100', '29:30:35', 'https://www.athlinks.com/event/33913/results/Event/754080/Course/1274553/Results'),
      new Race('2018-06-16', 'Leadville Trail Marathon', '5:44:46', 'https://www.athlinks.com/event/32707/results/Event/618379/Results'),
      new Race('2018-04-07', 'Colorado Invitational - 1500m', '4:33.7', '/results/CU_Invitational_Results_2018.pdf'),
      ...
      new Race('2016-08-13', 'Eastern States 100', 'DNF', 'http://www.easternstates100.com/'),
      ...
      new Race('2015-07-18', 'Vermont 100', '28:05:13', 'http://www.coolrunning.com/results/15/vt/Jul19_VT100E_set1.shtml'),
      ...
      new Race('2014-07-19', 'Vermont 100', 'DNF', '/results/vt100_2014.pdf'),
